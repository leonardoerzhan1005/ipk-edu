...
class CourseContentController extends Controller
{
    public function index(): View
    {
        ...
        return view('admin.course.course-contents.index', compact('courses'));
    }

    public function manage(string $courseId): View
    {
    ...
    function createChapterModal(string $course): String
    {
        // The route parameter is named {course}. Normalize to $id for the view.
        $id = $course;

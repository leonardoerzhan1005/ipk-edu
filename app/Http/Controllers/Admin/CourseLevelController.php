...
class CourseLevelController extends Controller
{
    ...
    public function store(Request $request) : RedirectResponse
    {
        ...
        return to_route('admin.course-levels.index', ['locale' => $request->route('locale')]);
    }

    /**
     * Show the form for editing the specified resource.
     */
    public function edit(string $locale, CourseLevel $course_level)
    {
     ...
     */
    public function update(Request $request, string $locale, CourseLevel $course_level)
    {
     ...
     */
    public function destroy(string $locale, CourseLevel $course_level)
    {
        try {
            $course_level->delete();

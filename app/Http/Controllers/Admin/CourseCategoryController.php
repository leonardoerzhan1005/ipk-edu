...
class CourseCategoryController extends Controller
{
    ...
    public function store(CourseCategoryStoreRequest $request) : RedirectResponse
    {
        ...
        return to_route('admin.course-categories.index', ['locale' => $request->route('locale')]);
    }

    /**
     * Show the form for editing the specified resource.
     */
    public function edit(string $locale, CourseCategory $course_category) : View
    {
     ...
     */
    public function update(CourseCategoryUpdateRequest $request, string $locale, CourseCategory $course_category)
    {
        // dd($request->all());
     ...
     */
    public function destroy(string $locale, CourseCategory $course_category, Request $request)
    {
        $category = $course_category;
        if (CourseCategory::where('parent_id', $category->id)->exists()) {

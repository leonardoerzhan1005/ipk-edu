...
class CourseLanguageController extends Controller
{
    ...
    public function store(Request $request) : RedirectResponse
    {
        ...
        return to_route('admin.course-languages.index', ['locale' => $request->route('locale')]);
    }
     ...
     */
    public function edit(string $locale, CourseLanguage $course_language)
    {
     ...
     */
    public function update(Request $request, string $locale, CourseLanguage $course_language)
    {
     ...
     */
    public function destroy(string $locale, CourseLanguage $course_language)
    {
        try {

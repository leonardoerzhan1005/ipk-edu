...
class BrandSectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.brand-section.index', ['locale' => $request->route('locale')]);
    }

    /**
     * Show the form for editing the specified resource.
     */
    public function edit($brand_section)
    {
        $brand = $brand_section instanceof Brand ? $brand_section : Brand::findOrFail($brand_section);
     ...
     */
    public function destroy($brand_section)
    {
        try {
            $brand = $brand_section instanceof Brand ? $brand_section : Brand::findOrFail($brand_section);

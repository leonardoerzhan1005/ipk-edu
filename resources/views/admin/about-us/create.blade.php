        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{__('Create About Us Section')}}</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.about-us.store', ['locale' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data" id="about-form">
                        @csrf
                        ...
                        <div class="card mb-3" id="ru-card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="translations[ru][title]" class="form-control" placeholder="Введите заголовок" value="{{ old('translations.ru.title') }}">
                                    <x-input-error :messages="$errors->get('translations.ru.title')" class="mt-2" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Подзаголовок (RU)</label>
                                    <input type="text" name="translations[ru][subtitle]" class="form-control" placeholder="Введите подзаголовок" value="{{ old('translations.ru.subtitle') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Описание (RU) *</label>
                                    <textarea name="translations[ru][description]" class="editor">{{ old('translations.ru.description') }}</textarea>
                        ...
                        <div class="card mb-3" id="kk-card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="translations[kk][title]" class="form-control" placeholder="Тақырыпты енгізіңіз" value="{{ old('translations.kk.title') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Қосымша тақырып (KK)</label>
                                    <input type="text" name="translations[kk][subtitle]" class="form-control" placeholder="Қосымша тақырыпты енгізіңіз" value="{{ old('translations.kk.subtitle') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Сипаттама (KK)</label>
                                    <textarea name="translations[kk][description]" class="editor">{{ old('translations.kk.description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3" id="en-card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="translations[en][title]" class="form-control" placeholder="Enter title" value="{{ old('translations.en.title') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Subtitle (EN)</label>
                                    <input type="text" name="translations[en][subtitle]" class="form-control" placeholder="Enter subtitle" value="{{ old('translations.en.subtitle') }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Description (EN)</label>
                                    <textarea name="translations[en][description]" class="editor">{{ old('translations.en.description') }}</textarea>
                                </div>
                            </div>
                        </div>

    ...
    <div class="add_course_basic_info">
        <form action="" class="more_info_form course-form" >
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="add_course_more_info_radio_box card p-4">
                        <h3>Applications Settings</h3>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="is_available_for_applications" value="1" id="is_available_for_applications" @checked($course?->is_available_for_applications)>
                            <label class="form-check-label" for="is_available_for_applications">Available for Applications</label>
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Faculty (optional)</label>
                            <select class="form-control select2" name="faculty_id" data-selected="{{ $course?->faculty_id }}">
                                <option value="">Please Select</option>
                            </select>
                        </div>
                        <div>
                            <label class="form-label">Specialization (optional)</label>
                            <select class="form-control select2" name="specialty_id" data-selected="{{ $course?->specialty_id }}">
                                <option value="">Please Select</option>
                            </select>
                        </div>
                    </div>

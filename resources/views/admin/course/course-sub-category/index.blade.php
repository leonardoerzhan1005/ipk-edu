            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('admin.course-categories.index', ['locale' => app()->getLocale()]) }}"
                            class="btn btn-dark">
                            <i class="ti ti-arrow-left"></i>
                            Back
                        </a>

                        <a href="{{ route('admin.course-sub-categories.create', ['locale' => app()->getLocale(), 'course_category' => $course_category->id]) }}"

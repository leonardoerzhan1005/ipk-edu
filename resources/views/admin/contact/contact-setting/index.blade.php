            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('admin.course-levels.index', ['locale' => request()->route('locale')]) }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.contact-setting.store', ['locale' => request()->route('locale')]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">

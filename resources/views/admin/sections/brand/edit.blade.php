            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('admin.brand-section.index', ['locale' => app()->getLocale()]) }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.brand-section.update', ['locale' => app()->getLocale(), 'brand_section' => $brand->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">

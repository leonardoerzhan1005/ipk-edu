    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.latest-courses-section.store', ['locale' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2" name="category_one">
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            @else
                                                <option @selected($latestCourseSection?->category_one == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2" name="category_two">
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            @else
                                                <option @selected($latestCourseSection?->category_two == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2" name="category_three">
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            @else
                                                <option @selected($latestCourseSection?->category_three == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2" name="category_four">
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            @else
                                                <option @selected($latestCourseSection?->category_four == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2" name="category_five">
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            @else
                                                <option @selected($latestCourseSection?->category_five == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endif
                                        @endforeach

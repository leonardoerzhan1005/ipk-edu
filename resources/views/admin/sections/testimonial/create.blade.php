        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.testimonial-section.index', ['locale' => app()->getLocale()]) }}" class="btn-sm btn-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.testimonial-section.store',['locale' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="translations[ru][review]" class="form-control" required></textarea>
                                    <x-input-error :messages="$errors->get('translations.ru.review')" class="mt-2" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Имя (RU)</label>
                                    <input type="text" class="form-control" name="translations[ru][name]" required>
                                    <x-input-error :messages="$errors->get('translations.ru.name')" class="mt-2" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Должность (RU)</label>
                                    <input type="text" class="form-control" name="translations[ru][title]" required>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="translations[kk][review]" class="form-control"></textarea>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="translations[en][review]" class="form-control"></textarea>

                                      ...
                                      @foreach ($recentBlogs as $blog)
                                          <tr>
                                              <td>
                                                  ...
                                                  <a href="{{ route('admin.blogs.edit', ['locale' => app()->getLocale(), 'blog' => $blog->id]) }}" class="ms-1"
                                                      aria-label="Open website"><!-- Download SVG icon from http://tabler-icons.io/i/link -->
                                                      <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                          height="24" viewBox="0 0 24 24" fill="none"
                                                          stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <table class="table table-vcenter">
                                    ...
                                    <tbody>
                                        @foreach ($recentOrders as $order)
                                            <tr>
                                              <td>
                                                <a href="{{ route('admin.orders.show', ['locale' => app()->getLocale(), 'order' => $order->id]) }}">
                                                  #{{ $order->invoice_id }}
                                                </a>
                                              </td>
                                                <td class="text-start">
                                ...
                                <table class="table table-vcenter">
                                    ...
                                    <tbody>
                                        @foreach ($recentApplications as $application)
                                            <tr>
                                                <td>
                                                    <a href="{{ route('admin.applications.show', ['locale' => app()->getLocale(), 'id' => $application->id]) }}" class="ms-1">
                                                        <i class="ti ti-file-text"></i>
                                                        {{ Str::limit($application->full_name, 30) }}
                                                    </a>
                                                </td>
                                                <td class="text-secondary">
                                                    @switch($application->status)
                                                        ...
                                                        @case('completed')
                                                            ...
                                                            @break
                                                        @default
                                                            <span class="badge bg-secondary text-white">{{ $application->status }}</span>
                                                    @endswitch
                                                </td>
                                            </tr>
                                        @endforeach

        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.login.store', ['locale' => app()->getLocale()]) }}" method="POST" autocomplete="off" novalidate>
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-2">
                            <label class="form-label">
                                ...
                                <span class="form-label-description">
                                    <a href="{{ route('admin.password.request', ['locale' => app()->getLocale()]) }}">I forgot password</a>
                                </span>
                            </label>

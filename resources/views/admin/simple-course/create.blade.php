      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Создать новый курс</h3>
          ...
          <form action="{{ route('admin.simple-courses.store', ['locale' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
            @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Введите название курса" required>
                    @error('title')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <input type="text" name="seo_description" class="form-control @error('seo_description') is-invalid @enderror" value="{{ old('seo_description') }}" placeholder="Краткое описание для поисковых систем">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label required">Изображение курса</label>
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="6" placeholder="Подробное описание курса" required>{{ old('description') }}</textarea>
                    @error('description')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <input type="number" name="discount" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount', 0) }}" min="0" step="0.01">
                    @error('discount')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <input type="number" name="capacity" class="form-control @error('capacity') is-invalid @enderror" value="{{ old('capacity') }}" min="1" placeholder="Не ограничено">
                    @error('capacity')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                      ...
                      <option value="pending" @selected(old('status', 'pending') == 'pending')>Ожидает</option>
                    </select>
                    @error('status')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <label class="form-check">
                        <input type="checkbox" name="is_approved" value="1" class="form-check-input" @checked(old('is_approved'))>
                        <span class="form-check-label">Одобрен</span>
                      </label>
                    </div>
                    <div class="col-md-4">
                      <label class="form-check">
                        <input type="checkbox" name="certificate" value="1" class="form-check-input" @checked(old('certificate'))>
                        <span class="form-check-label">Выдает сертификат</span>
                      </label>
                    </div>
                    <div class="col-md-4">
                      <label class="form-check">
                        <input type="checkbox" name="qna" value="1" class="form-check-input" @checked(old('qna'))>
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        ...
                        <input type="text" name="translations[{{ $locale }}][title]" class="form-control" value="{{ old("translations.{$locale}.title") }}" placeholder="Название на {{ $label }}">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">SEO описание</label>
                        <input type="text" name="translations[{{ $locale }}][seo_description]" class="form-control" value="{{ old("translations.{$locale}.seo_description") }}" placeholder="SEO описание на {{ $label }}">
                      </div>
                      <div class="mb-0">
                        <label class="form-label">Описание</label>
                        <textarea name="translations[{{ $locale }}][description]" class="form-control" rows="4" placeholder="Описание на {{ $label }}">{{ old("translations.{$locale}.description") }}</textarea>
                      </div>
                    </div>
                  </div>
                </div>

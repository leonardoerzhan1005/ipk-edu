    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.application-countries.update', ['locale' => app()->getLocale(), 'application_country' => $country->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        @php($trans = $country->translations->keyBy('locale'))

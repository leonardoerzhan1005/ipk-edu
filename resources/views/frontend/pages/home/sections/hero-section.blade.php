<section class="wsus__banner_3" style="background: url({{ asset('frontend/assets/images/banner_3_bg.png') }});">
    <div class="row justify-content-between">
       ...
       <p>{{ __('Welcome') }} - {{ app()->getLocale() }}</p>
     <p> {{ __('Home') }} - {{ app()->getLocale() }}</p>
       
         <p>Locale: {{ app()->getLocale() }} | Session: {{ session('locale') }} | Route: {{ request()->route('locale') }} | Segment: {{ request()->segment(1) }}

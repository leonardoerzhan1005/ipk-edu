...
@if(app()->getLocale() === 'kk')
    <div class="programs__block">
        🇰🇿 БАҒДАРЛАМАЛАР МЕН БАҒА ТУРАЛЫ АҚПАРАТ
        Әл-Фараби атындағы ҚазҰУ-дың Біліктілікті арттыру және қосымша білім беру институты барлық деңгейдегі білім беру мекемелеріне арналған икемді және қолжетімді бағдарламалар ұсынады. Біз әрбір тыңдаушыға сапалы білім мен заманауи тәжірибе арқылы кәсіби өсуге мүмкіндік береміз.
...
@elseif(app()->getLocale() === 'ru')
    <div class="programs__block">
        🇷🇺 ИНФОРМАЦИЯ О ПРОГРАММАХ И СТОИМОСТИ
        Институт повышения квалификации и дополнительного образования КазНУ имени әл-Фараби предлагает гибкие и доступные программы для всех уровней образования. Мы создаем возможности для профессионального роста, сочетая академические знания и практические навыки.
...
@else
    <div class="programs__block">
        🇬🇧 COURSE FEES AND PROGRAM INFORMATION
        The Institute for Advanced Training and Continuing Education of Al-Farabi KazNU offers flexible and affordable programs for schools, colleges, and universities. Our mission is to support professional growth through quality education and practical experience.
        📘 For schools and colleges – courses start from 25,000 KZT.
        🎓 For university lecturers and professionals – programs start from 72,000 KZT.
        All programs include instruction from qualified KazNU professors, flexible online/offline formats, and an official state-recognized certificate upon completion.
...
🇰🇿 БАҒДАРЛАМАЛАР МЕН БАҒА ТУРАЛЫ АҚПАРАТ
Әл-Фараби атындағы ҚазҰУ-дың Біліктілікті арттыру және қосымша білім беру институты барлық деңгейдегі білім беру мекемелеріне арналған икемді және қолжетімді бағдарламалар ұсынады.

...
@section('content')
    ...
    <section class="wsus__cart_view mt_120 xs_mt_100 pb_120 xs_pb_100">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro_name">
                                            <a href="{{ localizedRoute('courses.show', $item->course->translated_slug) }}">{{ $item->course->title }}</a>
                                        </td>
                                        <td class="pro_tk">
                                        ...
                                        <td class="pro_icon">
                                            <a href="{{ route('remove-from-cart', ['locale' => request()->route('locale'), 'id' => $item->id]) }}"><i class="fal fa-times" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    @empty
                                    <p>No data Found</p>
            ...
            <div class="row justify-content-between">
                <div class="col-xxl-7 col-md-5 col-lg-6 wow fadeInUp"
                    ...
                    <div class="continue_shopping">
                        <a href="{{ localizedRoute('courses.index') }}" class="common_btn">continue shopping</a>
                    </div>
                </div>
                <div class="col-xxl-4 col-md-7 col-lg-6 wow fadeInUp"
                    ...
                    <div class="total_price">
                        <div class="subtotal_area">
                            ...
                            <a href="{{ route('checkout.index', ['locale' => request()->route('locale')]) }}" class="common_btn">proceed checkout</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-center">
           ...
           <a href="{{ route('home', ['locale' => request()->route('locale')]) }}" class="common_btn mt-3">Go Home</a>
        </div>
        @endif
    </section>
    <!--===========================

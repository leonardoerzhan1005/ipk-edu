...
@push('meta')
    <meta property="og:title" content="{{ $blog->translated_seo_title }}">
    <meta property="og:description" content="{{ $blog->translated_seo_description }}">
...
@section('content')
    <!--===========================
        BREADCRUMB START
    ============================-->
    <section class="wsus__breadcrumb" style="bacground: #f4f4f4;">
    ...
    : $blog->created_at->translatedFormat('d F Y') }}
                            ...
                            <h2>{{ $blog->translated_title }}</h2>
                        </div>
                        <div class="wsus__blog_details_text">
                           {!! $blog->translated_description !!}
                        </div>
                        ...
                        <div class="wsus__blog_comment_input_area mt_75">
                            ...
                            <form action="{{ route('blog.comment.store', ['locale' => request()->route('locale'), 'id' => $blog->id]) }}" method="POST">
                                @csrf
                                <div class="row">
                ...
                <div class="col-lg-4 wow fadeInRight">
                    <div class="wsus__blog_sidebar wsus__sidebar">
                        <form action="{{ route('blog.index', ['locale' => request()->route('locale')]) }}" class="wsus__sidebar_search" method="get">
                        ...
                        <div class="wsus__sidebar_recent_post">
                            ...
                            <ul class="d-flex flex-wrap">
                                ...
                                <li class="w-100">
                                    <a href="{{ localizedRoute('blog.show', ['slug' => $blog->translated_slug]) }}" class="img">
                                    ...
                                    <div class="text">
                                        ...
                                        <a href="{{ localizedRoute('blog.show', ['slug' => $blog->translated_slug]) }}" class="title">{{ $blog->translated_title }}</a>
                                    </div>
                                </li>
                                @endif
                                @endforeach
                        ...
                        <div class="wsus__sidebar_blog_category">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('blog.index', ['locale' => request()->route('locale'), 'category' => $category->slug]) }}">{{ $category->name }} <span>({{ $category->blogs_count }})</span></a>
                                </li>
                                @endforeach

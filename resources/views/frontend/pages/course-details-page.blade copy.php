...
@push('meta')
    <meta property="og:title" content="{{ $course->translated_title }}">
    <meta property="og:description" content="{{ $course->translated_seo_description }}">
                    ...
                    <div class="wsus__courses_details_area mt_40">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-disabled2" role="tabpanel"
                                ...
                                @else
                                <div class="alert alert-info mt-3 text-center" role="alert">Please <a href="{{ route('login', ['locale' => app()->getLocale()]) }}">Login</a> First To Write A Review</div>
                                @endauth
                            </div>
                        </div>
                    </div>
